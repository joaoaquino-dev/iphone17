    ...
    <section className="bg-black py-20 px-6" id="design">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
          <h3 className="text-4xl font-bold mb-6 text-blue-400">A18 Pro</h3>
        ...
        <div id="camera" className="text-center">
          ...
          <div className="grid grid-cols-3 gap-6">
            <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              <div className="text-4xl font-bold text-blue-400 mb-4">48MP</div>
            ...
            <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              <div className="text-4xl font-bold text-slate-100 mb-4">12MP</div>
